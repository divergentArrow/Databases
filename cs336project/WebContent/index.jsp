		...
		<div class="aside">
			...
			<center>
				<button
					...
					class="LoginBtn Log">Login</button>
			</center>
			...
			<div id="id01" class="modal">
				<form method="POST" class="modal-content animate" action="login.jsp">
					...
					<div class="container">
						...
						<label for="Remember Me" style="color: black;"> <input
			...
			<center>
				<button
					...
					class="LoginBtn Log">Register</button>
			</center>
			<div id="id02" class="modal">
				<form method="POST" class="modal-content animate"
					...
					<div class="container">
						...
						<hr>
						<label for="email" style="color: black;"><b>Email/UserName</b></label>
						<div class="input-container">
							<i class="fa fa-user-circle-o icon"></i> <input type="text"
								placeholder="Enter Email" name="email_usr" required>
						</div>
